...
export default async function AdminLoginPage() {
  ...
  return (
    <main className="flex items-center justify-center min-h-screen p-5 admin-shell">
      ...
      <div className="w-full max-w-md">
        ...
        {hasSupabaseConfig ? <LoginForm /> : <div className="p-5 mt-10 text-sm leading-6 border border-amber-400/30 bg-amber-400/5 text-amber-200">Add the Supabase variables from <code>.env.example</code> to <code>.env.local</code>, then create your admin user.</div>}
      </div>
    </main>
  );
}
