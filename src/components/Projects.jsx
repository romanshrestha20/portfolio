  ...
  return (
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {/* Single Project Card */}
        <div className="max-w-sm mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:scale-105 transform transition-all duration-300">
          ...
          <div className="p-6">
            ...
            <div className="mt-4">
              <a
                href="https://github.com/your-profile/project-repo" // Replace with actual repo link
                target="_blank"
