        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          {/* Right Section: About Text */}
                ...
                <p className="font-serif text-xl leading-relaxed text-gray-800 dark:text-gray-300 tracking-wide">
                  Hello! My name is <strong className="text-primary dark:text-blue-400">Roman Shrestha</strong>. I am dedicated to problem-solving and exploring new technologies.
                </p>
                <p className="mt-6 font-serif text-xl leading-relaxed text-gray-800 dark:text-gray-300 tracking-wide">
                  I have experience working with <strong className="text-primary dark:text-blue-400">Java, JavaScript, React, Python, and Linux</strong>. I am continually eager to learn and advance in the field of technology.
                </p>
                <p className="mt-6 font-serif text-xl leading-relaxed text-gray-800 dark:text-gray-300 tracking-wide">
                  Outside of coding, I enjoy engaging in <strong className="text-green-600 dark:text-green-400">football</strong> and <strong className="text-primary dark:text-blue-400">traveling</strong>. Football keeps me active and teaches the importance of teamwork, while traveling provides new perspectives and inspires my creativity.
                </p>
                </motion.div>
              </div>
