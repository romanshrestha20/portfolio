    ...
    <motion.div
          ...
          >
            <p className="font-serif text-xl leading-relaxed text-gray-800 dark:text-gray-300 tracking-wide">
              ...
              . I am dedicated to problem-solving and exploring new
              technologies.
            </p>
            <p className="mt-6 font-serif text-xl leading-relaxed text-gray-800 dark:text-gray-300 tracking-wide">
              ...
              . I am continually eager to learn and advance in the field of
              technology.
            </p>
            <p className="mt-6 font-serif text-xl leading-relaxed text-gray-800 dark:text-gray-300 tracking-wide">
              ...
              . Football keeps me active and teaches the importance of teamwork,
              while traveling provides new perspectives and inspires my
              creativity.
            </p>
          </motion.div>
  );
